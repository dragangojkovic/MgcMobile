...
namespace MBoxMobile.Views
{
    ...
    public partial class InputNotificationsKWhPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            Resources["InputNotifications_KwhTitle"] = App.CurrentTranslation["InputNotifications_KwhTitle"];
            Resources["InputNotifications_KwhValue"] = NotificationModel.Kwh;
        ...
        public async void SubmitClicked(object sender, EventArgs e)
        {
            ...
            {
                Resources["IsLoading"] = true;
                bool result = await MBoxApiCalls.InputKwh(NotificationModel.ID, Opinion.Text, CauseID);
                Resources["IsLoading"] = false;
